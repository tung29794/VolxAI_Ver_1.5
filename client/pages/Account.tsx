...
import BatchWriteByKeywords from "@/components/BatchWriteByKeywords";
import WriteNewsForm from "@/components/WriteNewsForm";
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 w-full">
          <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            {activeTab === "write" && (
              <div className="space-y-6">
                {!isGenerating && activeWritingFeature === "keyword" && (
                  <button
                    onClick={handleBackToWritingMenu}
                ...
                {isGenerating && generationFormData ? (
                  ...
                  <ToplistForm
                    onSubmit={handleToplistFormSubmit}
                    isLoading={isGenerating}
                    onBack={handleBackToWritingMenu}
                  />
                ) : activeWritingFeature === "news" ? (
                  <WriteNewsForm
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {/* Viết dạng Toplist */}
                      <button
                        onClick={() => setActiveWritingFeature("toplist")}
                        className="bg-white rounded-2xl border border-border p-6 hover:shadow-lg transition-shadow cursor-pointer text-left"
                      >
                        <div className="flex items-start justify-between mb-4">
                      ...
                      {/* Viết Tin Tức */}
                      <button
                        onClick={() => setActiveWritingFeature("news")}
                        className="bg-white rounded-2xl border border-border p-6 hover:shadow-lg transition-shadow cursor-pointer text-left"
                      >
                        <div className="flex items-start justify-between mb-4">
                      ...
                      {/* Write Product Review - Coming Soon */}
                      ...
                      {/* Viết từ Facebook Post - Coming Soon */}
                      <div className="bg-gray-50 rounded-2xl border border-gray-200 p-6 relative opacity-60 cursor-not-allowed">
                        <div className="absolute top-3 right-3">
            ...
            {activeTab === "batch" && (
              <div className="space-y-6">
                {activeWritingFeature === "batch-keywords" ? (
